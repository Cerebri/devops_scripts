...
if($HostNested.HostNestedSupport) {
    ...
    #Spins up VM
    try {New-VM -Name $VMName -MemoryStartupBytes 3GB -Generation 1 -NewVHDPath "C:\Virtual Machines\$VMName\$VMName.vhdx" -NewVHDSizeBytes 53687091200 -BootDevice "VHD" -Path "C:\Virtual Machines\$VMName" }
    catch {}
