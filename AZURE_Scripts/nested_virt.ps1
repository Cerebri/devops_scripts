...
if($HostNested.HostNestedSupport) {
    ...
    #Spins up VM
    try {New-VM -Name $VMName -MemoryStartupBytes 7GB -Generation 1 -NewVHDPath "C:\Virtual Machines\$VMName\$VMName.vhdx" -NewVHDSizeBytes $VMSize -BootDevice "VHD" -Path "C:\Virtual Machines\$VMName" }
    catch {}
